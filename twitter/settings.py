...
SECRET_KEY = '4%q&732nou$1mq&$=t5n678epr+@c#ce9w@odd=94b_i@hj6=*'
...
# 实际web上使用aws3的服务，本地测试时使用django自带的
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-yue'
...
# celery专用的message queue在标号为2的redis数据库中
